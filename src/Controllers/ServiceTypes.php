...
class ServiceTypes
{
    ...
    */
    ...
    const BULK_WEBHOOK_RETRIGGER = 'BULK_WEBHOOK_RETRIGGER';
    ...
    const RETRIEVE_ALL_COLLECTION_ACCOUNT = 'RETRIEVE_ALL_COLLECTION_ACCOUNT';
    const ADMIN_COLLECTION_ACCOUNT_CREATED = 'ADMIN_COLLECTION_ACCOUNT_CREATED';
